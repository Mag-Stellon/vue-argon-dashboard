...
export default {
  ...
  mounted() {
    loadImage(`https://picsum.photos/${this.$el.parentNode.offsetWidth}/400`, (canvas => {
        this.image = canvas.toDataURL()
        this.start()
      }).bind(this), {
        maxWidth: this.$el.parentNode.offsetWidth,
        minWidth: 200,
        minHeight: 200,
        canvas: true,
        crossOrigin: 'picsum.photos',
      })
  },
...
.frame {
  display: flex;
  flex-wrap: wrap;
  background: #fff;//#612211 url('../../assets/img/board.jpg');
