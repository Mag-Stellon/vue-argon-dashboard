    ...
    <div class="row">
      <div class="col-xl-6 col-lg-4">
        <p class="text-white mt-0 mb-5">
          This sudoku board can be easily solved by just running through the numbers and adding them where they belong.<br/>
          Try to complete this puzzle as quickly as you can to gain the highest scores.
        </p>
      </div>
      <!-- Card stats -->
...
import Sudoku from '@/components/Sudoku/GameBoard'
...
export default {
  ...
  methods: {
    ...
    bestTime() {
      const bestTime = Storage.get('sudoku').bestTime;
      return bestTime ? bestTime.value : `${Number.MAX_SAFE_INTEGER}`;
    },
    bestDate() {
      const bestDate = Storage.get('sudoku').bestTime;
