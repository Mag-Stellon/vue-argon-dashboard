  ...
  <base-header class="base-header pb-6 pb-8 pt-5 pt-md-8">
    ...
    <div class="row">
      <div class="col-xl-6 col-lg-4">
        <p class="text-white mt-0 mb-5">Level up your brain with <b>Memory</b>. <br />Flip the cards and match the tiles together in pairs. <br />
          Try to complete pairs as quickly as you can to gain the highest scores.</p>
      </div>
      <!-- Card stats -->
...
export default {
  ...
  methods: {
    ...
    bestTime() {
      const bestTime = Storage.get('memory').bestTime;
      return bestTime ? bestTime.value : `${Number.MAX_SAFE_INTEGER}`;
    },
    bestDate() {
      const bestDate = Storage.get('memory').bestTime;
